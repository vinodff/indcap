...
const SfxControlPanel: React.FC<Props> = ({
  ...
  return (
    <div className="mb-2 rounded-xl border border-[var(--cc-border)] bg-[var(--cc-surface-2)] px-3 py-2">
      <div className="flex items-center gap-2 mb-2">
        <Music size={12} className="text-[var(--cc-blue-light)]" />
        <span className="text-[11px] font-semibold text-[var(--cc-text-1)]">Sound design</span>
        <span className="text-[9px] text-[var(--cc-text-3)]">{cueCount} cue{cueCount === 1 ? '' : 's'} placed</span>
      </div>
